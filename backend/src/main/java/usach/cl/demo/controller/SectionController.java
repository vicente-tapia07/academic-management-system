...
public class SectionController {
    ...
    public SectionController(SectionService sectionService, AuthorizationService authorizationService) {
    ...
    public ResponseEntity<List<SectionEntity>> findByProfessorActive(@PathVariable Long professorId,
                                                                      Authentication authentication) {
        authorizationService.requireProfessorAccess(authentication, professorId);
