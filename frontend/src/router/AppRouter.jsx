...
import MongoStudentCertificate from "../pages/mongo/StudentCertificate";
    ...
    <Layout>
      <Routes>
        ...
        >
          ...
          <Route path="/mongo/certificate" element={<MongoStudentCertificate />} />
          <Route
            path="/mongo/certificate/:studentId"
            element={<MongoStudentCertificate />}
          />
        </Route>
