...
export default function SemesterForm() {
  ...
  return (
    <div className="container py-4" style={{ maxWidth: 600 }}>
      ...
      <p className="text-muted mb-4">{isEdit ? `Modificando semestre #${id}` : 'Define el nuevo período académico'}</p>
          ...
          <form onSubmit={handleSubmit}>
            <div className="row g-3">
              <div className="col-sm-6">
                ...
                <input type="number" name="year" className="form-control" min="2020" max="2035"
                  value={form.year} onChange={handleChange} required />
              </div>
              <div className="col-sm-6">
                <label className="form-label fw-semibold">Período</label>
                <select name="period" className="form-select" value={form.period} onChange={handleChange} required>
                  <option value="1">Primer semestre</option>
                  <option value="2">Segundo semestre</option>
                </select>
              </div>

              <div className="col-12"><hr className="my-1" /><small className="text-muted fw-semibold">FECHAS DEL SEMESTRE</small></div>
              <div className="col-sm-6">
              ...
              <div className="col-12"><hr className="my-1" /><small className="text-muted fw-semibold">PERÍODO DE INGRESO DE NOTAS</small></div>
              <div className="col-sm-6">
            ...
            <div className="d-flex gap-2 mt-4">
              ...
              <button type="button" className="btn btn-outline-secondary" onClick={() => navigate('/semesters')}>
                Cancelar
              </button>
            </div>
          </form>
